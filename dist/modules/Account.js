...
function default_1(app, smtp) {
    ...
    app.post("".concat(globals.route_start, "/account/update/email"), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var token, user, e_10;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    ...
                    if (!(0, Permissions_1.hasPermission)(token.permissions, "UPDATE_EMAIL")) {
                        res.status(403).json({
